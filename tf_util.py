...
def conv1d(inputs,
    ...
    with tf.variable_scope(scope) as sc:
        ...
        if bn:
            outputs = batch_norm_for_conv1d(outputs, is_training, bn_decay=bn_decay, scope='bn', is_dist=is_dist)
...
def conv3d(inputs,
    ...
    with tf.variable_scope(scope) as sc:
        ...
        if bn:
            outputs = batch_norm_for_conv3d(outputs, is_training, bn_decay=bn_decay, scope='bn', is_dist=is_dist)
